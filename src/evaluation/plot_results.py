...
import torch
import pickle
from src.evaluation.preprocess import preprocess_dataframe, renumber_batch_idx
fs = 10
font = {'size': fs}
...
sd_hgb1, _ = open_mlpf_dataframe(os.path.join(dir_top, "showers_df_evaluation/test_plot106010_0_None.pt"), False, False)
...
sd_pandora1, _ = open_mlpf_dataframe(os.path.join(dir_top, "showers_df_evaluation/test_plot106010_0_None_pandora.pt"), False, False)
